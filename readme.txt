...
of the game is to get sets of 12 or more of the same coloured
block together.  Each level increases in speed and new coloured
blocks are added at intervals.

This example demonstrates how to use the Iw2D API to render
bitmapped images and fonts on the screen.  It shows how keypad or
